...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void StoreUserInformation() {
        ...
        if (ImageUri != null) {
            ...
            Toast.makeText(RegisterActivity.this, "請選擇圖片...", Toast.LENGTH_SHORT).show();
            loadingBar.dismiss();
        }
    }
        ...
        UserRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child(parentDbName).child(parentDbName + account).exists())) {
                        ...
                        UserRef.child(parentDbName).child(parentDbName + account).updateChildren(userMap)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            loadingBar.dismiss();
                                            Toast.makeText(RegisterActivity.this, "會員註冊成功..", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(RegisterActivity.this, LoginActivity.class);
                                            startActivity(intent);
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "帳號: " + account + "  ,已經存在了" + "請使用其他帳號...", Toast.LENGTH_SHORT).show();
                }
            }
