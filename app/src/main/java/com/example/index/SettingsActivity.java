...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePictureRef = FirebaseStorage.getInstance().getReference().child("User  Image"); //儲存庫
    ...
    private void updateOnlyUserInfo() {
        ...
        ref.child("Users" + Prevalent.currentOnlineUser.getAccount()).updateChildren(userMap);

        Prevalent.currentOnlineUser.setName(fullNameEditText.getText().toString());

        startActivity(new Intent(SettingsActivity.this, HomeActivity.class));
        Toast.makeText(SettingsActivity.this, "檔案已經都更改成功囉!", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void uploadImage() {
        ...
        if (imageUri != null) {
            ...
            final StorageReference fileRef = storageProfilePictureRef
                    .child("Users" + Prevalent.currentOnlineUser.getAccount() + ".jpg");
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {  //加了<Uri>
                    if (task.isSuccessful()) {
                        ...
                        startActivity(new Intent(SettingsActivity.this, HomeActivity.class));
                        Toast.makeText(SettingsActivity.this, "檔案更新成功", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(SettingsActivity.this, "錯誤", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(SettingsActivity.this, "沒有選擇照片", Toast.LENGTH_SHORT).show();
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText passwordEditText) {
        ...
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Users" + Prevalent.currentOnlineUser.getAccount());
